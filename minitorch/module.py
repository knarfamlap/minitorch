...
class Module:
    ...
    def named_parameters(self):
        ...
        def _get_parameters(root: Module, params):
            if len(root.modules) == 0:
                return 
            
            for k, v in root._parameters.items():
                params[k] = v
            
            for sub_module in root.modules:
                _get_parameters(sub_module, params)
            
        params = {}  
         
        _get_parameters(self, params) #
